<h2><a href="https://leetcode.com/problems/kth-smallest-element-in-a-sorted-matrix/?envType=problem-list-v2&envId=heap-priority-queue">378. Kth Smallest Element in a Sorted Matrix</a></h2><h3>Medium</h3><hr><p>Given an <code>n x n</code> <code>matrix</code> where each of the rows and columns is sorted in ascending order, return <em>the</em> <code>k<sup>th</sup></code> <em>smallest element in the matrix</em>.</p>
